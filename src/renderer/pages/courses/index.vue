  ...
  <div id="content-wrapper">
    ...
    >
          ...
          <v-dialog v-model="dialog" max-width="900px">
            <template v-slot:activator="{ on }">
              ...
              <v-btn
                ...
                >Import Course</v-btn
              >
              <v-btn color="#083666" dark class="mb-2" @click="resetCourses"
                >Reset Courses</v-btn
              >
            </template>
            <v-card>
              ...
              <v-card-text>
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="6">
                      <v-text-field
                        v-model.number="editedItem.par"
                        label="Par"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="6">
                      <v-text-field
                        v-model.number="editedItem.yards"
                        label="Yards"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12">
                    ...
                    <v-col
                      class="outlined"
                      cols="2"
                      v-for="(addHole, index) in addHoles"
                      :key="addHole.index"
                    >
      ...
      <template v-slot:item.action="{ item }">
        ...
        <v-icon small @click="exportItem(item)">
          fas fa-file-export
        </v-icon>
      </template>
      <template v-slot:no-data>
        <h3 class="font-weight-bold my-3">
          You have no courses in the database!
        </h3>
      </template>
    </v-data-table>
    <div class="d-flex">
