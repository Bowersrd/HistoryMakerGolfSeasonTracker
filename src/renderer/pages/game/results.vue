  ...
  <div class="d-flex align-center justify-center" id="results-wrapper">
    <div class="container">
      <div class="table-header">
        <p class="display-1 font-weight-bold white--text ml-5 mt-2">
          {{ event }}
        </p>
    ...
    <v-btn
      ...
      color="#083666"
      to="/season/home"
      @click.native="finalizeTournament"
    >
  ...
  computed: {
    ...
    eventPointValue() {
      return this.isPlayoffs
        ? this.$store.state.season.playoffSchedule[this.currentWeek].points
        : this.$store.state.season.schedule[this.currentWeek].points;
    }
  },
  methods: {
    finalizeTournament() {
