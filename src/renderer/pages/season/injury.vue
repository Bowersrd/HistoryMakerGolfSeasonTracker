  ...
  <div id="injury-wrapper">
    <div class="container d-flex flex-column align-center">
      <div class="d-flex align-center mb-10">
        ...
        <h1 class="display-2 text-uppercase font-weight-bold ml-5">
          Injury Report
        </h1>
        <v-btn class="ml-5" @click="dialog = !dialog">Add Injury</v-btn>
      </div>
      <h2 class="headline" v-if="injuredPlayers.length === 0">
        There are no injured players on tour.
      </h2>
      <v-card
        flat
        tile
      ...
      >
        <v-row>
          ...
          <v-col cols="1" class="d-flex align-center">
            <v-icon small @click="deleteItem(player)">
              fas fa-trash-alt
            </v-icon>
          </v-col>
        </v-row>
