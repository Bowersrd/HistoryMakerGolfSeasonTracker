  ...
  <div id="leaderboard-wrapper" class="d-flex flex-column justify-center">
    <div class="container">
      <div class="leaderboard-header d-flex align-center">
        <h1 class="headline text-uppercase font-weight-bold ml-5">
          ...
          <tbody>
            ...
            >
              ...
              <td>
                ...
                <span v-if="item.lastRank"
                  >&nbsp; {{ Math.abs(item.lastRank - item.rank) }}</span
                >
              </td>
              <td>
                <img
              ...
              <td>
                {{
                  Math.max(...players.map(player => player.points)) -
                    item.points ===
                  0
                    ? "-"
                    : Math.max(...players.map(player => player.points)) -
