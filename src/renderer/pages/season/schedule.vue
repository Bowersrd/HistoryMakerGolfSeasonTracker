<template>
  <div id="schedule-wrapper">
    <h1 class="display-2 font-weight-bold text-uppercase mb-8">
      Tournament Schedule
    </h1>
    <div class="schedule-box d-flex flex-column pa-5">
      <h2 class="title text-uppercase ml-3 mb-3 font-weight-bold">
        Regular Season
      </h2>
      <v-card
        flat
      ...
      >
        <v-row>
          ...
          <v-col class="d-flex" cols="2" v-if="!event.winner">
            ...
            <v-icon class="mr-4 mb-2" @click="moveDown(event)">
              fas fa-sort-down
            </v-icon>
            <v-icon small class="mr-4" @click="editItem(event)">
              fas fa-edit
            </v-icon>
      ...
      >
        <v-row>
          ...
          <v-col class="d-flex" cols="2" v-if="!event.winner">
            <v-icon small class="ml-12" @click="editItemPlayoff(event)">
              fas fa-edit
            </v-icon>
          </v-col>
        </v-row>
      ...
      <v-dialog v-model="dialog" max-width="500px">
        <v-card>
            ...
            <v-container>
              <v-row>
                ...
                <v-col cols="12" v-show="editedPlayoff">
                  <h2 class="subtitle-2 mt-n6">
                    *Only the course can be changed for the playoffs
                  </h2>
                </v-col>
          ...
          <v-card-actions>
            ...
            <v-btn color="blue darken-1" text @click="save" @keyup.enter="save"
              >Save</v-btn
            >
          </v-card-actions>
        </v-card>
